...
Location: /mail/
Expires: Mon, 22 Feb 2021 03:39:01 GMT
...
content-security-policy: script-src 'nonce-Wyzdmw0UcCQ+X1Wr06AUOA' 'unsafe-inline' 'unsafe-eval';object-src 'none';base-uri 'self';report-uri /cspreport
x-content-type-options: nosniff
x-xss-protection: 1; mode=block
server: GSE
set-cookie: __Host-GAPS=1:-eSODFNPm5LJ4nShrZuJJdAimtIWuA:IrBfU3TLPzeexWLM;Path=/;Expires=Wed, 22-Feb-2023 03:39:01 GMT;Secure;HttpOnly;Priority=HIGH
